...
return!0;if(c===b.content[0]||a.contains(b.content[0],c)){if(d)
return!0}else if(e&&a.contains(document,c))
...
return c.data.title;var d=b.st.image.titleSrc;if(d){if(a.isFunction(d))
