...
\large{
% \textbf{Entrepreneur | Product \& Growth at skillShack(); | Full Stack Developer | TedX Speaker | Blogger}
...
\begin{itemize}[leftmargin=0.15in]
  ...
  \item Built and scaled \textbf{skillShack();}, a global hub for programmers, reaching users in 130+ countries.
...
\resumeHeadingListStart{}
  ...
  {iSpace (ClaimShark)}{Telangana, India}
    \resumeItemListStart{}
      \resumeItem{Led technical solution design and implementation for enterprise clients, focusing on Artificial Intelligence and Machine Learning.}
      ...
      \resumeItem{Collaborated with cross-functional teams to deliver robust solutions tailored to client needs.}
    ...
    \resumeItemListEnd{}
  \resumeQuadHeadingChild{Senior Principal Architect - Technical}{Apr 2024 -- Jun 2025}
    \resumeItemListStart{}
      \resumeItem{Served as Senior Principal Architect, driving technical strategy and architecture for core products.}
      \resumeItem{Designed and implemented AI/ML pipelines and full-stack solutions using Go, Rust, Python, and Node.js.}
      \resumeItem{Worked in a hybrid environment, collaborating with teams in Hyderabad, Telangana, India.}
...
\section{\LARGE{Projects}}
  ...
  \resumeHeadingListStart{}
  \resumeQuadHeading{\href{https://braggi-ems.com/}{\uline{Braggi Election Management System (2.0)}}}{August 2022 -- Apr 2024}
  {Solo Founder \& Product}{}
      \resumeItemListStart{}
  ...
  \resumeHeadingListStart{}
  \resumeQuadHeading{{\uline{Stealth Project}}}{August 2023 -- Apr 2024}
  {Solo Founder \& Product}{}
      \resumeItemListStart{}
