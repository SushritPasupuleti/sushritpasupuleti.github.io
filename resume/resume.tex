...
\section{Full Stack Engineer | Product | DevOps}
\small{
...
\section{Projects}
  ...
  {Solo Founder \& Product}{}
      \resumeItemListStart{}
		\small{skillShack(); is a community for software professionals looking to share the projects they are working on and get feedback. From side projects to startups.}
  ...
  {Solo Founder \& Product}{}
      \resumeItemListStart{}
		\small{A stealth project that I am currently working on in parallel with my other projects, It is in the Health \& Fitness domain. This is a project that I am very excited about.}
...
\resumeItem{Handled \textbf{user studies} and \textbf{user research}.}
  ...
  {Solo Founder \& Product}{}
      \resumeItemListStart{}
		\small{Built a production quality chatbot service paired with cross-platform apps build on React and Flutter.}
		\resumeItem{Stack: \textbf{ReactJS,
			React-Redux,
			Redux,
			AWS,
  ...
  {Product}{}
      \resumeItemListStart{}
		\small{A smart electric meter add-on that connects to a standard electric meter and reports all usage metrics to a local hub which makes the data available via a mobile app and also to administration. Qualified for the CBSE National Science Fair's National level with this project!}
		\resumeItem{Stack: \textbf{ReactJS,
		Arduino}}
		\resumeItem{Handled \textbf{user studies} and \textbf{user research}.}
...
\section{Certifications}
  \small{I usually teach myself thing online over first-party Docs or FreeCodeCamp and avoid taking courses so that I can move at my pace. Sometimes however if a course is really good and worth the time I do get into it, like the ones below.
	}
  \resumeItemListStart{}
...
\section{Accomplishments/Brags/Hobbies}
\small{Cool things I've done and things I like to do in my free time!}
\resumeItemListStart{}
